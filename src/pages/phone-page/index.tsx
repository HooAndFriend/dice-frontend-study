...
const PhonePage = () => {
  ...
  return (
    <PhonePageView phone={phone} setPhone={setPhone} handlePhoneSave={handlePhoneSave} fetchPhoneListFromServer={fetchPhoneListFromServer} phoneList={phoneList} />
  );
};
